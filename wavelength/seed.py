...
SPECTRUMS = [
    ...
    # Mine
    ("Red flag", "Green flag", "General", "medium"),
    ("Boring date", "Fun date", "General", "medium"),
    ("Deserves their fame", "Doesn't deserve their fame", "General", "medium"),
    ("Toxic community", "Wholesome community", "General", "medium"),
    ("Gen Z", "Millenial", "General", "medium"),
    ("Terminally online knowledge", "Real world knowledge", "General", "medium"),
    ("Liberal", "Leftist", "General", "medium"),
    ("Political liability", "Political asset", "General", "medium"),
    ("NPC behavior", "Main character behavior", "General", "medium"),
    ("Fake job", "Real job", "General", "medium"),
